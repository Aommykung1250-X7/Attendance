...
| ศูนย์คำขอ | `/request` | พนักงานยื่นลา/ทำงานนอกสถานที่และติดตามผล |
| บันทึกประจำวัน | `/admin` | แอดมิน กดลา กดเช็กชื่อแทน แจ้งกลับก่อนแทน แก้ย้อนหลัง |
| คำขอ | `/admin/requests` | แอดมินอนุมัติใบลาและงานนอกสถานที่ |
...
| ตั้งค่า | `/admin/settings` | ลิงก์หน้าจอ อายุ QR วันหยุด เวลาผ่อนผัน และพื้นที่เช็กอิน |
