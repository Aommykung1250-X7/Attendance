...
- [ ] **ล้างข้อมูลทดสอบก่อนเปิดใช้จริง:**
  - **วิธีที่ 1 (แนะนำ - ลบเฉพาะประวัติการเข้างาน):** ไปที่หน้าเว็บ `/admin/settings` (ตั้งค่า) -> กดปุ่ม **"รีเซ็ตข้อมูลการเข้างาน..."** (พนักงาน, โปรเจกต์ และตารางกะจะยังอยู่ครบ ไม่ต้องกรอกใหม่)
  - **วิธีที่ 2 (ล้างทั้งหมดเพื่อเริ่มใหม่หมดจด):**
    ```bash
